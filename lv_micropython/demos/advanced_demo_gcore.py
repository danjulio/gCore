...
class Page_Text:
    def __init__(self, app, page):
        ...
        self.ta.set_height(lv.pct(60))
        self.ta.set_width(lv.pct(100))
        self.kbd = lv.keyboard(self.page)
        self.kbd.set_height(lv.pct(40))
        self.kbd.set_width(lv.pct(100))
...
class AdvancedDemoApplication:
    ...
    def init_gui_esp32(self):
        ...
        # Initialize gCore ILI9488 display
        from ili9XXX import ili9488g
        self.disp = ili9488g()

        # Register ft6236 touch driver running at 100 kHz I2C
        from ft6x36 import ft6x36
        self.touch = ft6x36(0, 21, 22, 100000)
