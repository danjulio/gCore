...
/*
 * A pre-configured version of Owen Carter's modified ESP32 cam program.  Original source
 * 
 * https://github.com/easytarget/esp32-cam-webserver
 * 
 * This sketch is designed to stream to the gCore disp_mjpg_stream sketch and is configured
 * as follows in the myconfig.h file:
 *    1. Acts as an Access Point (AP) - SSID: ESP32-CAM    Password: esp32cam
 *    2. Default streaming resolution: CIF 400x296 pixels
 *       Reasonable values: QQVGA, QVGA, CIF, HVGA (not all ESP32 Arduino version support HVGA)
 *    3. AI Thinker ESP32-CAM board pinout
 *    
 * gCore connects to "http://192.168.4.1:81" to get the mjpg stream.
 * 
 * Configure Arduino for "AI Thinker ESP32 CAM" and be sure to set IO0 low and then
 * reset the board to put it in programming mode (as explained in the Readme).
 * 
 * Owen's original comment block below.  See the readme.md file for more information.
 */
