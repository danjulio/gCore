/*
 * Adafruit's graphicstest ported to the TFT_eSPI TFT library
 * 
 * Requires the gCore_ILI9488 and the TFT_eSPI (modified for gCore) libraries.
 * 
 * Press and hold the power button for more than 5 seconds to power
 * off (this code does not make use of the soft power control).
 * 
 * The original Adafruit license is below.
 */
/***************************************************
...
void setup() {
  Serial.begin(115200);
  Serial.println("gCore_ILI9488 Test!"); 
...
//  tft.fillCircle(radius, radius, radius, color);
  return micros() - start;
}
